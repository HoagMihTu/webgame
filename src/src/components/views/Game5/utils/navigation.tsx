...
class Navigation {
    ...
    private async addAndShowScreen(screen: AppScreen) {
        if (!this.container.parent) {
            app_game5.stage.addChild(this.container);
        }
        ...
        if (screen.update) {
            app_game5.ticker.add(screen.update, screen);
        }
    ...
    private async hideAndRemoveScreen(screen: AppScreen) {
        ...
        if (screen.update) {
            app_game5.ticker.remove(screen.update, screen);
        }
