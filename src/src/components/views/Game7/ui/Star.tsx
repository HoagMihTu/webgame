...
export class Star extends Container {
    ...
    constructor() {
        super();
        this.image = Sprite.from('/common/star_2.png');
    ...
    public async show(animated = true) {
        ...
        if (animated) {
            ...
            await gsap.to(this.image.scale, { x: 0.75, y: 0.75, duration: 0.3, ease: 'back.out' });
        } else {
            this.image.scale.set(0.75);
        }
    }
    ...
    public async playStamp() {
        ...
        await gsap.to(this.image.scale, { x: 0.75, y: 0.75, duration: 0.5, ease: 'expo.in' });
    }
}
