...
export class Pet extends Container {
    ...
    constructor() {
        super();
        this.sprite = new Sprite(Texture.from('/game7/pet.png'))
        this.true_glow = new Sprite(Texture.from('/game7/outline_pet_true.png'))
        this.false_glow = new Sprite(Texture.from('/game7/outline_pet_false.png'))
