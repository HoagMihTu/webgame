...
export const app_game6 = new Application<HTMLCanvasElement>({
...
function resize() {
    ...
    app_game6.renderer.view.style.width = `${windowWidth}px`;
    app_game6.renderer.view.style.height = `${windowHeight}px`;
    window.scrollTo(0, 0);

    app_game6.renderer.resize(width, height);
...
async function init() {
    ...
    main.appendChild(app_game6.view);
