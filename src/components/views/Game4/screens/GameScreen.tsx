...
import { canvasScale, canvasWidth, canvasHeight } from '../Game4';
...
export class GameScreen extends Container {
    ...
    constructor() {
        ...
        this.celebation.scale.set(canvasScale)
    ...
    public setup(){
        ...
        for (let i = 0; i<10;i++){
            ...
            this.game_piece[i].scale.set(canvasScale)
            this.game_piece[i].interactive = true;
            this.game_piece[i].on('pointerover', () => this.game_piece[i].scale.set(1.2 * canvasScale))
                    .on('pointerout', ()=> this.game_piece[i].scale.set(1 * canvasScale))
                    .on('pointerup', ()=> {this.check_value(i)})
                    .on('pointerdown',()=> this.game_piece[i].scale.set(1 * canvasScale))
                    .on('pointerup',()=> this.game_piece[i].scale.set(1.2 * canvasScale));
    ...
    public async check_value(current_index: number) {
        ...
        if (check === -1){
            ...
            for (let k = 0; k < 10; k++) {
                this.game_piece[k].scale.set(1 * canvasScale)
