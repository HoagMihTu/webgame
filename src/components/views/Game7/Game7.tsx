...
export const app_game7 = new Application<HTMLCanvasElement>({
...
function resize() {
    ...
    app_game7.renderer.view.style.width = `${windowWidth}px`;
    app_game7.renderer.view.style.height = `${windowHeight}px`;
    window.scrollTo(0, 0);

    app_game7.renderer.resize(width, height);
...
async function init() {
    ...
    main.appendChild(app_game7.view);
